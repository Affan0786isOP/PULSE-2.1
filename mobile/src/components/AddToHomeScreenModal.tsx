            ...
            <div className="p-5 overflow-y-auto space-y-4">
              ...
              {isInstalled ? (
                ...
                <>
                  ...
                  {/* Device & Environment Specific Instructions */}
                  {isIos ? (
                    <div className="space-y-2.5">
                      ...
                      {!isSafari && (
                        <p className="text-xs text-amber-400/90 bg-amber-500/10 border border-amber-500/20 rounded-md p-2">
                          Note: iOS requires Apple Safari to add apps to your Home Screen. If currently in another browser, copy this URL and open it in Safari.
                        </p>
                      )}
                    ...
                    <div className="space-y-3">
                      ...
                      <button type="button"
                        ...
                        className="w-full py-2.5 px-4 rounded-lg bg-[var(--accent)] hover:opacity-90 text-[var(--bg-base)] font-mono font-bold text-xs uppercase tracking-wide flex items-center justify-center gap-2 transition-all cursor-pointer"
                      >
                        <Download size={14} />
                    ...
                    <div className="bg-[var(--surface-2)] border border-[var(--border-subtle)] rounded-lg p-3.5 space-y-2">
                      <p className="text-xs font-bold text-[var(--text-primary)]">Browser Not Supported</p>
                      <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
                        Direct installation is unavailable in this browser or in-app webview. To install PULSE as a standalone app, open this URL in <strong className="text-[var(--text-primary)]">Google Chrome</strong> (Android) or <strong className="text-[var(--text-primary)]">Apple Safari</strong> (iOS).
                      </p>
                    </div>
                  ) : (
                    <div className="space-y-3">
