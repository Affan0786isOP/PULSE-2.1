    ...
    >
      {!hasData ? (
        ...
        <div className="w-full flex flex-col gap-3 py-1">
          ...
          <div className="bg-[var(--bg-panel)]/40 border border-[var(--border-subtle)] rounded-lg p-3 sm:p-3.5">
            <div className="flex items-center justify-between text-[10px] font-mono text-[var(--text-muted)] uppercase tracking-wider mb-4">
            ...
            {positions && (
              <div className="relative w-full h-7 flex items-center mb-4">
                ...
                <div
                  className="absolute h-4.5 bg-[var(--cyan-primary)]/30 border border-[var(--cyan-primary)]/70 rounded"
                  style={{
                    left: `${positions.p25}%`,
                ...
                {/* Median pin */}
                <div
                  className="absolute w-1.5 h-6 bg-[var(--cyan-primary)] rounded-full -translate-x-1/2 z-10 shadow-[0_0_8px_rgba(34,199,214,0.6)]"
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 text-[10px] font-mono text-[var(--text-muted)] pt-1 border-t border-[var(--border-subtle)]/60">
              ...
              <div className="flex items-center gap-1.5">
                <span className="w-3.5 h-2 rounded-sm bg-[var(--cyan-primary)]/40 border border-[var(--cyan-primary)]" />
                <span>IQR (p25–p75)</span>
              </div>
              <div className="flex items-center gap-1.5">
                <span className="w-3.5 h-1.5 rounded-sm bg-[var(--cyan-primary)]/15 border border-[var(--cyan-primary)]/30" />
                <span>p10–p90</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-1.5 font-mono text-xs">
            <div className="p-2 rounded-lg bg-[var(--bg-panel)]/40 border border-[var(--border-subtle)]">
            ...
            <div className="p-2 rounded-lg bg-[var(--cyan-badge-bg)] border border-[var(--cyan-badge-border)]">
