      ...
      >
        ...
        >
          ...
          <section className="flex flex-col gap-4">
            ...
            <div className="bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-xl p-5 shadow-sm">
              ...
              <ul className="text-sm text-[var(--text-secondary)] list-disc pl-5 space-y-2 mt-4">
                ...
                <li><strong className="text-[var(--text-primary)]">Cryptographic Attestation & Anonymous Auth:</strong> Server-generated HMAC tokens and anonymous Firebase authentication ensure session ownership and metric validity without requiring user-provided identifying information or registered accounts. Anonymous Firebase UIDs remain private and are omitted from public research dataset records.</li>
          ...
          <section className="flex flex-col gap-4">
            ...
            <div className="bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-xl p-5 shadow-sm">
              <p className="text-sm text-[var(--text-secondary)] leading-relaxed mb-4">
                We collect age cohort brackets (e.g., "18–25") rather than exact birthdates to prevent age-based fingerprinting.
              </p>
          ...
          <section className="flex flex-col gap-4">
            ...
            <div className="bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-xl p-5 shadow-sm">
              <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
                All validated assessment records and global leaderboard rankings are authoritatively managed and securely persisted in the server database (Firebase / Firestore). Research submissions require no user-provided identifying information (PII) or registered user accounts. To verify secure session ownership and maintain server-side integrity, the system utilizes anonymous Firebase authentication. The resulting user identifier (UID) is retained exclusively in private server-side canonical records and is not exposed or included in public research dataset records. Resetting local app cache in settings clears only transient client-side UI display preferences from your device.
              </p>
            </div>
          </section>
        </motion.div>
