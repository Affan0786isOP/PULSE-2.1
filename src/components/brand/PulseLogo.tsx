...
export const PulseLogo: React.FC<PulseLogoProps> = ({
  ...
  // Standalone P-Symbol Path Elements
  const symbolPaths = (
    <>
      {/* S1: Upper Loop / Arch */}
      <path 
  ...
  if (variant === 'stacked') {
    return (
      <div className={`inline-flex flex-col items-center select-none ${className}`}>
        ...
        <span className="font-mono text-[9px] tracking-[0.18em] text-[#7E808C] uppercase mt-1">
          COGNITIVE BENCHMARK &amp; LATENCY ENGINE
        </span>
      </div>
    );
  }

  // Default: Horizontal Lockup (Matching Reference Panel 4 & 8)
  return (
